...
export function Presentation() {
    ...
    return (
        <section 
            id='presentation' 
            className='flex flex-col-reverse lg:flex-row md:flex-row sm:flex-col-reverse justify-center items-center w-full lg:max-w-6xl md:max-w-4xl mt-20 md:mt-32 px-4 md:px-0 gap-8 mb-32 scroll-mt-32'>
